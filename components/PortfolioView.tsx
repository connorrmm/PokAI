'use client';
/**
 * The portfolio's presentation, separated from where its data comes from.
 *
 * Split out so /preview/portfolio renders THE REAL COMPONENT with sample
 * numbers. A mockup built separately drifts from the product within days and
 * then misrepresents it -- which matters most in exactly the situation a
 * preview exists for.
 */
...
export default function PortfolioView({ data, isAnonymous = false }: {
  data: Data;
  isAnonymous?: boolean;
}) {
